...
$subject	= "Murphys Salem // Functions Contact Form";	// Email Subject
...
$message .= "Event Date: " . $_POST['date'] . "<br>";
$message .= "Event Type: " . $_POST['eventType'] . "<br>";
$message .= "Start Time: " . $_POST['startTime'] . "<br>";
$message .= "Guest Count: " . $_POST['guestCount'] . "<br>";
$message .= "Menu: " . $_POST['menu'] . "<br><br>";
$message .= "Message:<br>";

$comments = $message . htmlspecialchars($_POST['comments']) . $copy;
